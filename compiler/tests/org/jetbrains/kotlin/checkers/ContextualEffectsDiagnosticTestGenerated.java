...
public class ContextualEffectsDiagnosticTestGenerated extends AbstractContextualEffectsDiagnosticTest {
    ...
    @TestMetadata("compiler/testData/diagnostics/contextualEffects/dummyCFAtests")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class DummyCFAtests extends AbstractContextualEffectsDiagnosticTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doTest, TargetBackend.ANY, testDataFilePath);
        }

        public void testAllFilesPresentInDummyCFAtests() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/diagnostics/contextualEffects/dummyCFAtests"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.ANY, true);
        }

        @TestMetadata("breakContinueReturn.kt")
        public void testBreakContinueReturn() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/breakContinueReturn.kt");
        }

        @TestMetadata("doWhile.kt")
        public void testDoWhile() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/doWhile.kt");
        }

        @TestMetadata("elvis.kt")
        public void testElvis() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/elvis.kt");
        }

        @TestMetadata("for.kt")
        public void testFor() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/for.kt");
        }

        @TestMetadata("if.kt")
        public void testIf() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/if.kt");
        }

        @TestMetadata("innerFunctions.kt")
        public void testInnerFunctions() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/innerFunctions.kt");
        }

        @TestMetadata("lambda.kt")
        public void testLambda() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/lambda.kt");
        }

        @TestMetadata("multipleExceptions.kt")
        public void testMultipleExceptions() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/multipleExceptions.kt");
        }

        @TestMetadata("simple.kt")
        public void testSimple() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/simple.kt");
        }

        @TestMetadata("when.kt")
        public void testWhen() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/when.kt");
        }

        @TestMetadata("while.kt")
        public void testWhile() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/while.kt");
        }

        @TestMetadata("whileTrue.kt")
        public void testWhileTrue() throws Exception {
            runTest("compiler/testData/diagnostics/contextualEffects/dummyCFAtests/whileTrue.kt");
        }
    }
